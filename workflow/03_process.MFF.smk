...
rule filter_monomorphic_bcftools: 
    ...
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.bcftools.vcf.gz",
...
rule isec_bcftools_eva:
    ...
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.bcftools.vcf.gz",
        csi = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.bcftools.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule filter_monomorphic_freebayes: 
    ...
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.freebayes.vcf.gz",
...
rule isec_freebayes_eva:
    ...
    input:
        ...
        eva_csi = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz.csi"
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.freebayes.vcf.gz",
        csi = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.freebayes.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule filter_monomorphic_haplotypeCaller: 
    ...
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.haplotypeCaller.vcf.gz",
...
rule isec_haplotypeCaller_eva:
    ...
    input:
        ...
        eva_csi = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz.csi"
    output:
        filtered = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.haplotypeCaller.vcf.gz",
        csi = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.haplotypeCaller.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule filter_DP_bcftools_private_snps:
    ...
    input:
        ...
        csi = "results/05_private/{samples}.MFF.norm.monomorphic.DPFilt.eva.bcftools.intersection.MQ60.vcf.gz.csi",
    output:
        filtered = "results/05_private/{samples}.MFF.norm.monomorphic.DPFilt.eva.bcftools.intersection.MQ60.DP.vcf.gz",
        csi = "results/05_private/{samples}.MFF.norm.monomorphic.DPFilt.eva.bcftools.intersection.MQ60.DP.vcf.gz.csi",
    threads: 8
    conda:
        "bcftools-1.19"
    resources:
...
rule bcftools_stats_private_MQ:
    ...
    input:
        filtered = "results/05_private/{samples}.MFF.norm.monomorphic.DPFilt.eva.bcftools.intersection.MQ60.DP.vcf.gz",
    output:
        stats = "results/00_stats/{samples}.MFF.norm.monomorphic.DPFilt.eva.bcftools.intersection.MQ60.DP.vcf.gz.bcftools-stats.txt",
    threads: 6
    conda:
        "bcftools-1.19"
    resources:
